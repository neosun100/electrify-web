...
- 🧹 自動清理無效記錄（應用被手動刪除時）
- 📍 自動更新路徑（應用被移動到 /Applications 時）

### v1.1.1 (2025-12-21)

- 🔍 智慧應用路徑偵測（支援 macOS/Linux 移動後的應用）

### v1.1.0 (2025-12-21)

- ✨ 新指令: `eweb list` - 列出所有已安裝的應用
- ✨ 新指令: `eweb remove <name>` - 解除安裝應用
- 📝 應用註冊表位於 `~/.electrify-web/registry.json`

### v1.0.7 (2025-12-21)

- 🔧 修復: 確保 `cli.js` 有執行權限，支援全域安裝

### v1.0.6 (2025-12-21)

- 💬 改進: 圖示轉換失敗時提供更友善的錯誤提示

### v1.0.5 (2025-12-21)

- 🔧 修復: 修正 macOS `iconutil` 所需的圖示尺寸（移除無效的 64x64）

### v1.0.4 (2025-12-21)

- ✨ 新功能: 預設啟用 PWA 偵測（`--pwa` 現在預設為 true）

### v1.0.3 (2025-12-21)

- 🔧 修復: macOS 上優先使用原生 `sips` 而非 ImageMagick 進行圖示轉換

### v1.0.2 (2025-12-21)

- 🔧 修復: 支援 ImageMagick v7（使用 `magick` 指令替代已棄用的 `convert`）
