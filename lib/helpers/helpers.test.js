...
describe('camelCased', () => {
    test('has no hyphens in camel case', () => {
        expect((0, helpers_1.camelCased)('file-download')).toEqual(expect.not.stringMatching(/-/));
    });
    test('returns camel cased string', () => {
        expect((0, helpers_1.camelCased)('file-download')).toBe('fileDownload');
    });
    test('has no spaces in camel case', () => {
        expect((0, helpers_1.camelCased)('--file--download--')).toBe('fileDownload');
    });
    test('handles multiple hyphens properly', () => {
        expect((0, helpers_1.camelCased)('file--download--options')).toBe('fileDownloadOptions');
    });
    test('does not affect non-snake cased strings', () => {
        expect((0, helpers_1.camelCased)('win32options')).toBe('win32options');
    });
});
